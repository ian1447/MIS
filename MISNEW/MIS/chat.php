...
<body>
    ...
    <form class="searchbox" method="POST" >   
        <input type="text" id="search_text" placeholder=" Search Chat...." name="searchtext">   
    ...
    <div class="cardh_container">
        <?php
            ...
            while($result = mysqli_fetch_assoc($actresult)) {?>
                <a href="chatbatch.php?course_abb=<?php echo $result['course_abb']; ?>" >
                    <div class="cardh">
                        <div>
        ...
        <?php
            ...
            {?>
                <div class="admin_add_container">
                    <a href="addcourse.php?page=chat">
